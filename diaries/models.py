...
class Diary(models.Model):
    ...
    diary_text=models.TextField(max_length=100000,verbose_name=u'日记内容')
    diary_title=models.CharField(max_length=200,verbose_name=u'日结标题')
    diary_sortid=models.IntegerField(primary_key=True,db_column="DiaryId",default=1)
    ...
    Person_intrest=models.ManyToManyField(Person_intrest,verbose_name=u'个人爱好')
    Public_intrest=models.ManyToManyField(Public_intrest,
                                          verbose_name=u'公共爱好')
    Diary_share=models.CharField(max_length=50,choices=share_or_not,
                                 default=None,verbose_name=u'是否分享')
    class Meta:
